...
class StripePay extends StatefulWidget {
  @override
  _StripePay createState() => new _StripePay();
}

class _StripePay extends State<StripePay> {
  Token _paymentToken;
  PaymentMethod _paymentMethod;
  String _error;
  final String _currentSecret =
      "sk_test_51HsR3wGaJnbtdG28KTJOQWUSxnbMlHbhvEv8xDWsq6BV00iY7GVDiRkSIgF8mpyc3xXdsBpiENOn2bYusCeEQC3N00mWcuwNlq"; //set this yourself, e.g using curl
